...
In simple Lnaguage GuardRails are like boundaries for user and agent, which prevent user and agent to cross the given limit.
like it checks the input prompt doesn't contains any kind of sensitive data, secret keys, personal data, dangerous actions, abusive language.

You can make GuardRail to generate response as per given queries, not to generate unrelevant response
